...
add_file -vhdl "../rtl/saturn_lpddr_100MHz_nodebug.vhd"
...
set_option -top_module "saturn_lpddr_100MHz_nodebug"
...
project -result_file "../synth/rev_1/saturn_lpddr_100MHz_nodebug.edf"
