...
xfile add "../rtl/saturn_lpddr_100MHz_nodebug.vhd"

xfile add "saturn_lpddr_100MHz_nodebug.ucf"
...
project set "Library Search Order" "../synth/saturn_lpddr_100MHz_nodebug.lso" -process "Synthesize - XST"
